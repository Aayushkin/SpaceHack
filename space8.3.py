...
class Jeu():
    ...
    def ecran(self,couleur=(0,0,0,)):
        ...
        pygame.display.set_caption('SpaceHack - Made By Mr. Aayush Bhandari')
        ...
        if self.rect.left>0 and self.rect.left<jeu.width:
            ...
            if self.rect.colliderect(vaisseau.rect):
                ...
                if randomize==1:
                    ...
                    if vaisseau.power>1:
                        if 'vaisseau' in globals():
                            vaisseau.power -= 1
                        else:
                            print("Error: 'vaisseau' is not defined.")
                self.rect=None
    ...
    while choix!=0:
        ...
        if choix==3:
            ...
            scroll = generic.Scrolling([
                ("Made By Mr. Aayush Bhandari", "c", 24),  # Added credit
